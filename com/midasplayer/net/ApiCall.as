package com.midasplayer.net
{
   ...
   public class ApiCall
   {
      ...
      public function ApiCall(param1:String, param2:URLVariables, param3:Function, param4:Function, param5:int, param6:Object = null)
      {
         super();
         Debug.assert(param1 != null,"Creating an api call with no url.");
         Debug.assert(param5 > 0,"Trying to create an api call with no tries.");
         this._url = param1;
      ...
      {
         var _loc_1:URLRequest = new URLRequest(this._url);
