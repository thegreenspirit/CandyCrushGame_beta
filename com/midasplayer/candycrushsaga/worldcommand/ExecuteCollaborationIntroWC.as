package com.midasplayer.candycrushsaga.worldcommand
{
   ...
   public class ExecuteCollaborationIntroWC extends WorldCommand
   {
      private var getWorldCommandHandlerFn:Function;
      
      private var episodeId:int;
      
      public function ExecuteCollaborationIntroWC(param1:int, param2:Function)
      {
         super();
      ...
      override public function triggerCommand() : void
      {
         ...
         _loc_1.executeCollaborationIntro(this.episodeId,this.endCommand);
      }
