package com.midasplayer.candycrushsaga.worldcommand
{
   ...
   public class ExecuteTransportIntroWC extends WorldCommand
   {
      private var getWorldCommandHandlerFn:Function;
      
      private var episodeId:int;
      
      public function ExecuteTransportIntroWC(param1:int, param2:Function)
      {
         super();
      ...
      override public function triggerCommand() : void
      {
         ...
         _loc_1.executeTransportIntro(this.episodeId,this.endCommand);
      }
