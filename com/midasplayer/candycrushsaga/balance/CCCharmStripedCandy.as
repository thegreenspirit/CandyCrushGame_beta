package com.midasplayer.candycrushsaga.balance
{
   ...
   public class CCCharmStripedCandy extends CCCharm
   {
      public function CCCharmStripedCandy(param1:String, param2:ItemProduct, param3:Boolean = false, param4:Boolean = false)
      {
