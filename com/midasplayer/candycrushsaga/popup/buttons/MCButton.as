package com.midasplayer.candycrushsaga.popup.buttons
{
   ...
   public class MCButton
   {
      ...
      public function MCButton(param1:MovieClip, param2:Function)
      {
         super();
      ...
      public function activate() : void
      {
         ...
         this._buttonClip.gotoAndStop(NORMAL);
         this._buttonClip.buttonMode = true;
      }
      ...
      public function deactivate() : void
      {
         ...
         this._buttonClip.gotoAndStop(INACTIVE);
      ...
      {
         if(this._buttonClip.currentFrameLabel != PRESSED)
         {
            this._buttonClip.gotoAndStop(PRESSED);
         }
      }
      
      protected function _onUp() : void
      {
         if(this._buttonClip.currentFrameLabel != NORMAL)
         {
            this._buttonClip.gotoAndStop(NORMAL);
         }
      }
      ...
      {
         if(this._buttonClip.currentFrameLabel != HOVERED)
         {
            this._buttonClip.gotoAndStop(HOVERED);
         }
      }
