package com.king.saga.api.event
{
   ...
   public class LevelLockedEvent extends SagaEvent
   {
      public static const Type:String = "LEVEL_LOCKED";
      
      private var _episodeId:int;
      
      private var _levelId:int;
      
      public function LevelLockedEvent(param1:Object, param2:Object)
      {
         super(param1,Type);
