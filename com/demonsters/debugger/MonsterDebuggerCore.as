package com.demonsters.debugger
{
   ...
   internal class MonsterDebuggerCore
   {
      ...
      internal static function initialize() : void
      {
         ...
         _monitorTimer.start();
         if(Boolean(_base.hasOwnProperty("stage")) && _base["stage"] != null && _base["stage"] is Stage)
         {
      ...
      internal static function sendInformation() : void
      {
         ...
         if(_base is DisplayObject && Boolean(_base.hasOwnProperty("loaderInfo")))
         {
         ...
         if(playerType == "Desktop")
         {
            try
            {
               ...
               if(NativeApplicationClass != null)
               {
                  ...
                  {
                     filename += ".exe";
                     _loc_2 = FileClass["applicationDirectory"];
      ...
      private static function highlightUpdate() : void
      {
         ...
         if(_highlightMouse)
         {
            ...
            if(Capabilities.playerType == "Desktop")
            {
               ...
               if(_loc_1 != null && _loc_1["nativeApplication"]["activeWindow"] != null)
               {
